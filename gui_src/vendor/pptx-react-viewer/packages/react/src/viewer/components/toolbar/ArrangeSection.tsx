...
export function ArrangeSection(p: ArrangeSectionProps): React.ReactElement {
	...
	return (
		<>
			<RibbonGroup label={t('pptx.ribbon.group.align')}>
				<div className={grp}>
			...
			<RibbonGroup label={t('pptx.ribbon.group.order')}>
				<div className={grp}>
					<button
			...
			<RibbonGroup label={t('pptx.ribbon.group.rotate')}>
				<div className={grp}>
					<button
						type='button'
			...
			<RibbonGroup label={t('pptx.ribbon.clipboard')}>
				<div className={grp}>
					...
					{/* Paste stays enabled whenever editing is allowed: the system
					    clipboard may hold a pasteable image or text that no in-app state
					    can see, and it can only be inspected by reading it. */}
					<button
						onClick={p.onPaste}
						disabled={!p.canEdit}
						className={gL}
			...
			<RibbonGroup label={t('pptx.ribbon.group.element')}>
				<button
