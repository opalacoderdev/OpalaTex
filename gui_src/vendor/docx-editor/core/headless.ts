 ...
 * @example
 * ```ts
 * import { DocumentAgent, parseDocx, pluginRegistry } from '@docx-editor.dev/core/headless';
 * import { docxtemplaterPlugin } from '@docx-editor.dev/core/core-plugins';
 *
 * // Register plugins
