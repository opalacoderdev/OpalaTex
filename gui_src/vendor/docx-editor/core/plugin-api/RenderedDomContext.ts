 ...
 * data-doc-from and data-doc-to attributes that LayoutPainter adds
 * to span elements.
 */
export class RenderedDomContextImpl implements RenderedDomContext {
  ...
  getCoordinatesForPosition(pmPos: number): PositionCoordinates | null {
    ...
    const spans = this.pagesContainer.querySelectorAll('span[data-doc-from][data-doc-to]');
