  ...
  return {
    ...
    fontScheme: {
      majorFont: {
        ...
        ea: '',
        cs: '',
        fonts: { Jpan: 'ＭＳ ゴシック', Hang: '맑은 고딕', Hans: '宋体', Arab: 'Times New Roman' },
      },
      minorFont: {
        latin: 'Century',
        ea: '',
        cs: '',
        fonts: { Jpan: 'ＭＳ 明朝', Hang: '맑은 고딕', Hans: '宋体', Arab: 'Arial' },
      },
    },
  };
}
...
describe('applyThemeFontLang', () => {
  ...
  test('fills empty complex-script slots from the bidi language', () => {
    ...
    expect(theme.fontScheme.minorFont?.ea).toBe(''); // untouched without an eastAsia lang
