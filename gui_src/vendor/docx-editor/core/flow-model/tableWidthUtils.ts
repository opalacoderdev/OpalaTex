...
import type { TableBlock } from '../pagination-model';
 ...
 * and the row-break pageComposer all consume this so they agree on which column a
 ...
 * budget — the width half of `measureTable`, with NO cell-content
 ...
 * `totalWidth` that `measureTable` produces.
 *
 * @internal
 */
