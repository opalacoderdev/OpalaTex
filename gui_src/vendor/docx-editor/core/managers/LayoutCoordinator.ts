 ...
 * - Selection state (selectionGeometry, caretPosition)
...
export class LayoutCoordinator extends Subscribable<LayoutCoordinatorSnapshot> {
  ...
  // Selection state
  private _selectionGeometry: SelectionBox[] = [];
  ...
  updateSelection(selectionGeometry: SelectionBox[], caretPosition: CaretPosition | null): void {
    this._selectionGeometry = selectionGeometry;
  ...
  private emitSnapshot(): void {
    ...
    this.setSnapshot({
      ...
      selectionGeometry: this._selectionGeometry,
