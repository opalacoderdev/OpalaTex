...
datas = [('opalatex/gui', 'opalatex/gui'), ('opalatex/icon.png', 'opalatex'), ('opalatex/assetstore', 'opalatex/assetstore'), ('opalatex/templates', 'opalatex/templates'), ('opalatex/guides', 'opalatex/guides'), ('bin', 'bin'), ('config.yaml', '.'), ('skills', 'skills'), ('version_info.txt', '.')]
