...
_STRINGS = {
    ...
    "pt": {
        ...
        "serialized_tool_call_nudge": "Sua última mensagem continha uma chamada de ferramenta escrita como texto (JSON ou marcação <tool_call>/<function=...>). Texto nunca é uma chamada de ferramenta e nada o executa. Se você ainda precisa dessa ação, execute-a agora pelo protocolo nativo de chamada de ferramentas do provedor. Se o trabalho já está concluído, responda com a resposta final ao usuário em texto normal.",
